...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Dentist Marketing Pro`}</title>

        <meta
          name="description"
          content="Experience the power of targeted growth with Dentist Marketing Pro, your ultimate sales app for effective dentist marketing programs."
        />
      </Head>
      ...
      <Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }}>
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Heading fontSize={{ base: '3xl', md: '4xl', lg: '5xl' }}>
              ...
              >
                {`Dentist Marketing Pro`}
              </Text>
            </Heading>
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Experience the power of targeted growth with Dentist Marketing Pro, your ultimate sales app for effective dentist marketing programs.`}
            </Text>
            <Stack direction="column" spacing={4} className="roles-container">
              <Text>Dentalclinic</Text>
        ...
        <Flex position="relative" flex={1}>
          <Image
            src={
              'https://images.unsplash.com/photo-1557804506-669a67965ba0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkZW50aXN0JTJDc2FsZXN8ZW58MHx8fHwxNjg4NTk1NDY2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt={'Login Image'}
            objectFit={'cover'}
          />
